...
const deleteProducts = async() => {
    url = 'https://realwafers-2.onrender.com/product';
    ...
    for (let product of products) {
        const response = await axios.delete(`https://realwafers-2.onrender.com/product/${product.id}`)
...
var checkout = async() => {
    ...
    var payable = 0;
    url = 'https://wafers-1.onrender.com/product';
